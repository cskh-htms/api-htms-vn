...
async  function function_export(req, res, next) {
	...
	try {	
		...
		try {
			...
			return res.send({ 
				"error" : "1", 
				"position":"web->controller->notes->manage->show-all",
				"message": error_send 
			}); 
		...
		res.render( ojs_configs.view_version + '/notes/manage-show-all',  data_send );
