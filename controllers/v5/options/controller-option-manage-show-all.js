...
async  function function_export(req, res, next) {
	...
	try {	
		...
		try {
			...
			return res.send({ 
				"error" : "1", 
				"position":"web->controller->option->manage->show-all",
				"message": error_send 
			}); 
		...
		res.render( ojs_configs.view_version + '/options/speciality/manage-show-all',  data_send );
