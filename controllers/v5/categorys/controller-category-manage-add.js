...
async  function function_export(req, res, next) {
	...
	try {	
		...
		try {
			...
			res.send({ 
				"error" : "1", 
				"position":"web->appdalacom->controller->category->manage->add",
				"message": error_send 
			}); 
			return;			
		}		
		...
		try {
			...
			//res.send(data_send);
			//return;		
			res.render( ojs_configs.view_version + '/categorys/general/speciality/manage-add',  data_send );
