...
async  function function_export(req, res, next) {
	...
	try {	
		...
		try {
			...
			return res.send({ 
				"error" : "1", 
				"position":"web->appdalacom->controllers->admin->discounts->delete",
				"message": error_send 
			}); 
						
		}		
		//return res.send({"error":"00","message":[discount_program_id]});
		//	
		...
		var data_api_resuilt = await ojs_shares_fetch_data.get_data_send_token_delete(
				...
				'/admin/discounts/delete?c1='+ discount_program_id,
				token
			);	
