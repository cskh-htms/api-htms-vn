...
async  function function_export(req, res, next) {
	...
	try {	
		...
		try {
			...
			return res.send({ 
				"error" : "1", 
				"position":"web->controller->brands->manage->show-all",
				"message": error_send 
			}); 
		...
		var data_api_resuilt = await ojs_shares_fetch_data.get_data_send_token_get(
				...
				'/discount-program/show-all?c1=' + store_id, 
				token
			);				
		...
		res.render( ojs_configs.view_version + '/discount-program/speciality/manage-show-all', data_send );
