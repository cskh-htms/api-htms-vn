...
source ./01.table_reviews_insert.sql;

source ./02.table_reviews_update.sql;
...
--
-- tao check insert
source ./sql/demo_check_update_v4.sql;


--
-- tao constraint
source ./sql/demo_constraint_v4.sql;



--
-- tao trigger
source ./sql/demo_trigger_backup_v4.sql;
...
--
-- insert database
source ./sql/demo_datas_origin_v4.sql;
