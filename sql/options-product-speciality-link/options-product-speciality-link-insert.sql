...
-- @
-- @
DROP TRIGGER  IF EXISTS  trig_options_product_speciality_link_before_insert;
DELIMITER $$ 
CREATE TRIGGER trig_options_product_speciality_link_before_insert BEFORE INSERT ON dala_options_product_speciality_link  
FOR EACH ROW  
BEGIN  
--
--
	...
	ELSE
		...
		SET MESSAGE_TEXT = 'trig_options_product_speciality_link_insert_option_id_not_refer'; 
	END IF;		
