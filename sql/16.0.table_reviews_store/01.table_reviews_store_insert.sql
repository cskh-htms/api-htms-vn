...
DELIMITER $$ 
CREATE TRIGGER trig_reviews_store_speciality_user_id_insert BEFORE INSERT ON dala_reviews_store_speciality  
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_reviews_store_speciality_store_id_insert BEFORE INSERT ON dala_reviews_store_speciality 
FOR EACH ROW  
BEGIN  
