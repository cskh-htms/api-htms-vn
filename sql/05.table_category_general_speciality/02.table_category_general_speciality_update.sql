...
DELIMITER $$ 
CREATE TRIGGER trig_category_general_speciality_name_update BEFORE INSERT ON dala_category_general_speciality 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_category_general_speciality_stores_id_update BEFORE INSERT ON dala_category_general_speciality 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_category_general_speciality_category_parent_id_update BEFORE INSERT ON dala_category_general_speciality 
FOR EACH ROW  
BEGIN  
