...
DELIMITER $$ 
CREATE TRIGGER trig_category_general_speciality_link_update BEFORE UPDATE ON dala_category_general_speciality_link 
FOR EACH ROW  
BEGIN  
	...
	ELSE
		...
		SET MESSAGE_TEXT = 'trig_category_general_speciality_link_update_product_id_not_refer'; 
	END IF;	
