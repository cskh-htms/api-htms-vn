...
DELIMITER $$ 
CREATE TRIGGER trig_brands_name BEFORE INSERT ON dala_brands 
FOR EACH ROW  
BEGIN  
...
DROP TRIGGER  IF EXISTS  trig_brands_stores_id;
-- 

DELIMITER $$ 
CREATE TRIGGER trig_brands_stores_id BEFORE INSERT ON dala_brands 
FOR EACH ROW  
BEGIN  
