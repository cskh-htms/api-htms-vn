...
DELIMITER $$ 
CREATE TRIGGER trig_options_product_speciality_name BEFORE INSERT ON dala_options_product_speciality 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_options_product_speciality_stores_id BEFORE INSERT ON dala_options_product_speciality 
FOR EACH ROW  
BEGIN  
