...
DELIMITER $$ 
CREATE TRIGGER trig_category_news_name BEFORE INSERT ON dala_category_news 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_category_news_stores_id BEFORE INSERT ON dala_category_news  
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_category_news_parent_id BEFORE INSERT ON dala_category_news  
FOR EACH ROW  
BEGIN  
