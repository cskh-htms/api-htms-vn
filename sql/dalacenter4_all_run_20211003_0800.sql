...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Bảng giá shipping từng khu vực nhập vào';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trig_shipping_speciality_insert` BEFORE INSERT ON `dala_shipping_speciality` FOR EACH ROW BEGIN  
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trig_shipping_speciality_update` BEFORE UPDATE ON `dala_shipping_speciality` FOR EACH ROW BEGIN  
...
-- Dump completed on 2021-10-03  8:04:09
