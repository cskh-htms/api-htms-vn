...
DELIMITER $$ 
CREATE TRIGGER trig_stores_name BEFORE INSERT ON dala_stores 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_stores_user_id BEFORE INSERT ON dala_stores 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_stores_service_type_id BEFORE INSERT ON dala_stores 
FOR EACH ROW  
BEGIN  
