...
DELIMITER $$ 
CREATE TRIGGER trig_orders_speciality_phone_update BEFORE UPDATE ON dala_orders_speciality 
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_orders_speciality_email_update BEFORE UPDATE ON dala_orders_speciality  
FOR EACH ROW  
BEGIN  
...
DELIMITER $$ 
CREATE TRIGGER trig_orders_speciality_user_id_update BEFORE UPDATE ON dala_orders_speciality   
FOR EACH ROW  
BEGIN  
