...
router.use('/bo-cong-thuong', require('./bo-cong-thuong/routers-bo-cong-thuong'));
router.use('/users', require('./users/routers-users'));
router.use('/admin', require('./admin/routers-admin'));
router.use('/categorys', require('./categorys/routers-category'));
router.use('/options', require('./options/routers-option'));
