...
const ojs_shares_fetch_data = 
	require('../../../../shares/' + 
		config_api.API_SHARES_VERSION + '/ojs-shares-fetch-data.js');
...
const check_owner_store = 
	require('../../../../shares/' + 
		config_api.API_SHARES_VERSION + '/check-owner-store');
const order_search = 
	require('../../../../lib/' + 
		config_api.API_LIB_VERSION + '/order-details/order-detail-search-by-store.js');
const order_get_one = 
	require('../../../../lib/' + 
		config_api.API_LIB_VERSION + '/orders/orders-get-one.js');
const order_detail_search = 
	require('../../../../lib/' + 
		config_api.API_LIB_VERSION + '/order-details/order-detail-search-by-product.js');
const shipping_tracking_search = 
	require('../../../../lib/' + 
		config_api.API_LIB_VERSION + '/shipping-tracking/shipping-tracking-search.js');
const order_detail_coupon = 
	require('../../../../lib/' + 
		config_api.API_LIB_VERSION + '/order-details/order-detail-search-by-coupon.js');
...
async  function function_export(req, res, next) {
	...
	try{
		...
		try{	
			...
			return res.send({ 
				"error" : "100", 
				"position" : "api->appdalacom->controller->bussiness->ajax-load-order-detail",
				"message": error_send 
			}); 
