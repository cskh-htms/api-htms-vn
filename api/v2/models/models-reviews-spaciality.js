...
let sql_select_all = 	"" + 	
	...
	ojs_configs.db_prefix  + "reviews_speciality_status_store as reviews_speciality_status_store, " + 
...
var check_review_link = async function (product_id) {
	...
	let sql_text = 	"SELECT " +  ojs_configs.db_prefix + "reviews_speciality_ID " +  
					...
					sql_link_default + 
					" where " + 
 					ojs_configs.db_prefix + "reviews_speciality_product_id = '" + product_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var check_review_link_user = async function (user_id) {
	...
	let sql_text = 	"SELECT " +  ojs_configs.db_prefix + "reviews_speciality_ID " +  
					...
					sql_link_default + 
					" where " + 
 					ojs_configs.db_prefix + "reviews_speciality_user_id = '" + user_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
