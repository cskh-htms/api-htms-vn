...
let sql_select_all = 	"" + 	
	...
	ojs_configs.db_prefix  + "coupon_speciality_formula as coupon_speciality_formula, " + 
	...
	ojs_configs.db_prefix  + "coupon_speciality_price as coupon_speciality_price, "  + 
	ojs_configs.db_prefix  + "coupon_speciality_price_max as coupon_speciality_price_max, "  + 
	ojs_configs.db_prefix  + "coupon_speciality_qty as coupon_speciality_qty, "  + 
	ojs_configs.db_prefix  + "coupon_speciality_multi as coupon_speciality_multi "  
...
let sql_order_default = " order by " + 
	ojs_configs.db_prefix + "coupon_speciality_code " ;
...
var insert_coupon_spaciality = async function (datas) {
	//@
	let sql_text = "INSERT INTO " + ojs_configs.db_prefix + "coupon_speciality  SET ?";
	let dataGo = {
...
var get_one_coupon_spaciality = async function (coupon_id) {
	...
	let sql_text = 	"SELECT " +  sql_select_all + 
					...
					sql_link_default + 
					" where " + 
 					ojs_configs.db_prefix + "coupon_speciality_ID = '" + coupon_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var check_comment_link = async function (coupon_id) {
	...
	let sql_text = 	"SELECT " + ojs_configs.db_prefix +  "coupon_speciality_ID " + 
					...
					sql_link_default + 
					" where " + 
 					ojs_configs.db_prefix + "coupon_speciality_coupon_id = '" + coupon_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var check_comment_link_user = async function (user_id) {
	...
	let sql_text = 	"SELECT " + ojs_configs.db_prefix +  "coupon_speciality_ID " + 
					...
					sql_link_default + 
					" where " + 
 					ojs_configs.db_prefix + "coupon_speciality_user_id = '" + user_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var update_coupon_spaciality = async function (datas,coupon_id) {
	...
	let table_name  = ojs_configs.db_prefix + "coupon_speciality ";
	let field_where  = ojs_configs.db_prefix + "coupon_speciality_ID ";
	//create sql text
