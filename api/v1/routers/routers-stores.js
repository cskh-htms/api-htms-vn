...
//get one
router.get('/:stores_id', middle_ware, controllers_stores.get_one_stores);

//update
router.put('/:stores_id', middle_ware, controllers_stores.update_stores);

//delete
router.delete('/:stores_id', middle_ware ,controllers_stores.delete_stores);
