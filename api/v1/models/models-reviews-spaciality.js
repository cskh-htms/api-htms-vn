...
//sql select default
let sql_select_all = 	"" + 	
	ojs_api_config.db_prefix  + "reviews_speciality_ID as reviews_speciality_ID, " + 
	"DATE_FORMAT(" + ojs_api_config.db_prefix  + "reviews_speciality_date_created," + "'%Y/%m/%d %H:%i:%s'"  + ") as reviews_speciality_date_created, " + 	
	ojs_api_config.db_prefix  + "reviews_speciality_user_id as reviews_speciality_user_id, " + 
	ojs_api_config.db_prefix  + "reviews_speciality_product_id as reviews_speciality_product_id, " + 
	ojs_api_config.db_prefix  + "reviews_speciality_contents as reviews_speciality_contents, " + 
	ojs_api_config.db_prefix  + "reviews_speciality_status_store as reviews_speciality_status_store, " + 
	ojs_api_config.db_prefix  + "reviews_speciality_status_admin as reviews_speciality_status_admin, " +  
	ojs_api_config.db_prefix  + "reviews_speciality_number_star as reviews_speciality_number_star, "  + 
...
let sql_from_default = 	" from " + 
	ojs_api_config.db_prefix + "reviews_speciality "  ;
...
let sql_link_default = 	""  + 
	...
	ojs_api_config.db_prefix + "reviews_speciality_user_id  = " + 
	ojs_api_config.db_prefix + "users_ID " +    
	
	" INNER JOIN " + 
	ojs_api_config.db_prefix + "products_speciality  ON  " + 
	ojs_api_config.db_prefix + "reviews_speciality_product_id  = " + 
	ojs_api_config.db_prefix + "products_speciality_ID " 	


//link table	
let sql_order_default = " order by " + 
	ojs_api_config.db_prefix + "reviews_speciality_date_created " ;
...
//@@
//insert
var insert_reviews_spaciality = async function (datas) {
	//@
	let sql_text = "INSERT INTO " + ojs_api_config.db_prefix + "reviews_speciality  SET ?";
	let dataGo = {
			...
			"reviews_speciality_status_store"				: datas.reviews_speciality_status_store,
...
var get_all_reviews_spaciality = async function () {
	//create sql text
...
//@@
//get ALL category chung;
var get_one_reviews_spaciality = async function (review_id) {
	//create sql text
	let sql_text = 	"SELECT " +  sql_select_all + 
					sql_from_default + 
					sql_link_default + 
					" where " + 
 					ojs_api_config.db_prefix + "reviews_speciality_ID = '" + review_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
//@@
//check review link
var check_review_link = async function (product_id) {
	//create sql text
	let sql_text = 	"SELECT " +  ojs_api_config.db_prefix + "reviews_speciality_ID " +  
					sql_from_default + 
					sql_link_default + 
					" where " + 
 					ojs_api_config.db_prefix + "reviews_speciality_product_id = '" + product_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
//@@
//check review link
var check_review_link_user = async function (user_id) {
	//create sql text
	let sql_text = 	"SELECT " +  ojs_api_config.db_prefix + "reviews_speciality_ID " +  
					sql_from_default + 
					sql_link_default + 
					" where " + 
 					ojs_api_config.db_prefix + "reviews_speciality_user_id = '" + user_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
//@@
//insert
var update_reviews_spaciality = async function (datas,review_id) {
	...
	let table_name  = ojs_api_config.db_prefix + "reviews_speciality ";
	let field_where  = ojs_api_config.db_prefix + "reviews_speciality_ID ";
	//create sql text
...
//@@
//insert
var delete_reviews_spaciality = async function (review_id) {
