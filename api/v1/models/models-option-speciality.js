...
//from table
let sql_select_all = 	"" + 	
	ojs_api_config.db_prefix  + "options_product_speciality_ID as options_product_speciality_ID, " + 
	ojs_api_config.db_prefix  + "options_product_speciality_name as options_product_speciality_name, " + 
	ojs_api_config.db_prefix  + "options_product_speciality_featured_image as options_product_speciality_featured_image, " + 
	ojs_api_config.db_prefix  + "options_product_speciality_parent_id as options_product_speciality_parent_id, " + 
	ojs_api_config.db_prefix  + "options_product_speciality_information as options_product_speciality_information, " + 
	ojs_api_config.db_prefix  + "options_product_speciality_date_created as options_product_speciality_date_created "
...
let sql_from_default = 	" from " + 
	ojs_api_config.db_prefix + "options_product_speciality "  ;
...
let sql_order_default = " order by " + 
	ojs_api_config.db_prefix + "options_product_speciality_name" ;
...
var insert_option_speciality = async function (datas) {
	//@
	let sql_text = "INSERT INTO " + ojs_api_config.db_prefix + "options_product_speciality  SET ?";
	let dataGo = {
...
var get_one_option_speciality = async function (option_id) {
	...
	let sql_text = 	"SELECT " +  sql_select_all + 
					...
					sql_link_default + 
					"where " + 
					ojs_api_config.db_prefix + "options_product_speciality_ID = '" + option_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var update_option_speciality = async function (datas,option_id) {
	...
	let table_name  = ojs_api_config.db_prefix + "options_product_speciality ";
	let field_where  = ojs_api_config.db_prefix + "options_product_speciality_ID ";
	//create sql text
