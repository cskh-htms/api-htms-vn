...
//sql select default
let sql_select_all = 	"" + 	
	ojs_api_config.db_prefix  + "orders_speciality_ID as orders_speciality_ID, " + 
	ojs_api_config.db_prefix  + "users_first_name as users_first_name, " + 
	ojs_api_config.db_prefix  + "users_last_name as users_last_name, " + 
	ojs_api_config.db_prefix  + "orders_speciality_phone as orders_speciality_phone, " + 
	"DATE_FORMAT(" + ojs_api_config.db_prefix  + "orders_speciality_date_orders," + "'%Y/%m/%d %H:%i:%s'"  + ") as orders_speciality_date_orders, " + 	
	ojs_api_config.db_prefix  + "orders_speciality_user_id as orders_speciality_user_id, " + 
	ojs_api_config.db_prefix  + "orders_speciality_status_orders as orders_speciality_status_orders, " + 
	ojs_api_config.db_prefix  + "orders_speciality_status_payment as orders_speciality_status_payment, " + 
	ojs_api_config.db_prefix  + "orders_speciality_adress as orders_speciality_adress, " + 
	ojs_api_config.db_prefix  + "orders_speciality_notes as orders_speciality_notes, " + 
	ojs_api_config.db_prefix  + "orders_speciality_email as orders_speciality_email " 



//from table
let sql_from_default = 	" from " + 
	ojs_api_config.db_prefix + "orders_speciality "  ;
...
let sql_order_default = " order by " + 
	ojs_api_config.db_prefix + "orders_speciality_date_orders " ;
...
let sql_select_all_view = 	"" + 	
	...
	ojs_api_config.db_prefix  + "orders_details_speciality_price_caution as orders_details_speciality_price_caution, " + 
	ojs_api_config.db_prefix  + "orders_details_speciality_discount_caution as orders_details_speciality_discount_caution " 
...
let sql_from_default_view = 	" from " + 
	ojs_api_config.db_prefix + "view_order_report "  ;	
...
var insert_orders_spaciality = async function (datas) {
	//@
	let sql_text = "INSERT INTO " + ojs_api_config.db_prefix + "orders_speciality  SET ?";
	let dataGo = {
...
var get_one_orders_spaciality = async function (order_id) {
	...
	let sql_text = 	"SELECT " +  sql_select_all + 
					...
					sql_link_default + 
					" where " + 
 					ojs_api_config.db_prefix + "orders_speciality_ID = '" + order_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var check_order_link_user = async function (user_id) {
	//create sql text
	let sql_text = 	"SELECT " + ojs_api_config.db_prefix + "orders_speciality_ID " + 
					sql_from_default + 
					sql_link_default + 
					" where " + 
 					ojs_api_config.db_prefix + "orders_speciality_user_id = '" + user_id + "' " + 
					sql_order_default
	//@
	try {
		return new Promise( (resolve,reject) => {
...
var update_orders_spaciality = async function (datas,order_id) {
	...
	let table_name  = ojs_api_config.db_prefix + "orders_speciality ";
	let field_where  = ojs_api_config.db_prefix + "orders_speciality_ID ";
	//create sql text
...
var delete_orders_spaciality = async function (order_id) {
	...
	let table_name_detail  = ojs_api_config.db_prefix + "orders_details_speciality ";
	let field_where_detail  = ojs_api_config.db_prefix + "orders_details_speciality_order_id ";
...
var insert_orders_spaciality_app = async function (datas,data_details) {
	...
	sql_text = "INSERT INTO " + ojs_api_config.db_prefix + "orders_speciality  SET ? ; ";
	...
	if(data_details.length > 0){
		...
		for(let i = 0; i < data_details.length; i ++){
			///ex
			sql_details = "INSERT INTO " + ojs_api_config.db_prefix + "orders_details_speciality  ";
			sql_details = sql_details + "(" +
							ojs_api_config.db_prefix + "orders_details_speciality_order_id" + "," + 
							ojs_api_config.db_prefix + "orders_details_speciality_line_order" + "," + 
							ojs_api_config.db_prefix + "orders_details_speciality_product_id " + "," + 
							ojs_api_config.db_prefix + "orders_details_speciality_qty " + "," + 
							ojs_api_config.db_prefix + "orders_details_speciality_price " + "," + 							
							ojs_api_config.db_prefix + "orders_details_speciality_discount " + "," + 
							ojs_api_config.db_prefix + "orders_details_speciality_unit_discount " + 
						") " + 
						"values(" + 
						"@aa, '" + 
