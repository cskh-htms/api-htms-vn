		...
		if(Object.keys(field_arr).length == 0){
			...
			for (var x in field_arr){
				...
				if(field_arr[x] == "orders_details_speciality_qty_sum" ){	
					sql_field_check  = "sum(" + ojs_api_config.db_prefix  + "orders_details_speciality_qty" + ")";
					...
					sql_field_check  = 	"sum(if(" + ojs_api_config.db_prefix + "orders_details_speciality_unit_discount = 0 , " + 
					
											ojs_api_config.db_prefix + "orders_details_speciality_discount * " + 
											ojs_api_config.db_prefix + "orders_details_speciality_price / 100  * " + 
											ojs_api_config.db_prefix + "orders_details_speciality_qty, " +  
