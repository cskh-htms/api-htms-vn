...
//@
async  function controllers_products_store_delete(req, res, next) {
	...
	try{		
		...
		|| check_role_result == "admin" 
			...
			res.send({ 
				"error" : "333",
				"position" : "ctroller->api-appdalacom->controllers-products-store-delete-appdalacom-api.js", 
				"message": error_send 
			}); 
			return;			
		}	
...
module.exports = controllers_products_store_delete;