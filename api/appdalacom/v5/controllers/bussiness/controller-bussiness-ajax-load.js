...
async  function function_export(req, res, next) {
	...
	try {
		...
		return res.send({ 
			"error" : "1", 
			"position" : "api/appdalacom/controller/bussiness/controllers-bussiness-ajax-load",
			"message": error_send 
		}); 
	...
	//@ check owner user id
	const check_owner_user_resuilt = await check_owner_user.check_owner_user(token,datas.user_id,res);
	if(	
