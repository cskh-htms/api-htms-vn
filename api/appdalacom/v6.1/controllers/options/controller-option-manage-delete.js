...
const option_delete = require('../../../../lib/' + config_api.API_LIB_VERSION + '/options/option-delete');
	...
	try {	
		...
		try {
			...
			if(req.query.c1){
				...
				return res.send({ 
					"error" : "01", 
					"position" : "api->appdalacom->controller->options->manage->delete",
		...
		//return res.send([option_id,store_id]);
		//
		...
		//@	
		//@ run database
		var result = await option_delete(option_id,res);
