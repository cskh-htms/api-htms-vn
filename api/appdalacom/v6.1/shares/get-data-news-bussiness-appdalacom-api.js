...
const get_data_news_bussiness = async function (store_id,res){
	...
	var fn_get_datas_order = new Promise((resolve, reject) => {
		let result = orders_search_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_category = new Promise((resolve, reject) => {
		let result = category_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_option = new Promise((resolve, reject) => {
		let result = option_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_brand = new Promise((resolve, reject) => {
		let result = brand_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_product = new Promise((resolve, reject) => {
		let result = product_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_discount = new Promise((resolve, reject) => {
		let result = discount_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_discount_detail = new Promise((resolve, reject) => {
		let result = discount_detail_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_discount_product = new Promise((resolve, reject) => {
		let result = discount_product_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_review = new Promise((resolve, reject) => {
		let result = review_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_coupon = new Promise((resolve, reject) => {
		let result = coupon_news_bussiness(store_id,res);
		resolve(result);
	});	
	...
	var fn_get_datas_note = new Promise((resolve, reject) => {
		let result = note_news_bussiness(store_id,res);
		resolve(result);
	});	
