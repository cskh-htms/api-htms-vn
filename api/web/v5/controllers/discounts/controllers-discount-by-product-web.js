...
async  function controllers_discount_by_product_app(req, res, next) {
	...
	try {
		...
		res.send({ 
			"error" : "1", 
			"position" : "api/web/v5/ctroller/discounts/controllers_discount_by_product_app",
			"message": error_send 
		}); 
		return;	
	}
	...
	try{
		...
		res.send ({ 
			"error" : "3", 
			"position":"api/web/v5/controller/discounts/controllers-discount-by-product-app",
			"message": error_send 
		});
	}		
