...
async  function function_export(req, res, next) {
	try {
		...
		return res.send({ "error" : "2", "position":"api/web/v5/ctronller/controllers-meta-adress/update-web", "message": error_send } );
	...
	check_owner_result == "1"
		...
		return res.send({ 
			"error" : "22",
			"position" : "api/web/v5/ctronller/controllers-meta-adress/update-web",
			"message": error_send 
		}); 
