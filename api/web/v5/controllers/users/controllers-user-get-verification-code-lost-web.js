...
async  function function_export(req, res, next) {
	...
	try {
		...
		if(req.query.c1){
			...
			return res.send({ 
				"error" : "01", 
				"position" : "api/app/v5/ctronller/controllers-user-verification-code-lost-web-client",
	...
	//@
	//@ call api			
	var data_api_resuilt = await ojs_shares_fetch_data.get_data_no_token_get(
			ojs_configs.domain + '/api/web/' + 
			config_api.API_APPDALACOM_VERSION + 
			'/users/get-verification-code-lost?c1=' + phone
		);				
